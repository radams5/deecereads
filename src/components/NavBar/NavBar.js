...
render(){
  const SearchBar2 = <SearchBar style={{width: '350px'}}  setSearchState={this.setSearchState} location={this.props.location} history={this.props.history} toggleSearch={this.toggleSearch}/>
  ...
  return(
    ...
    <h1 style = {{margin: "8px 0px"}} onClick={(e) => this.handleNavigation("/Home")}>deeceReads</h1>
    <div style = {{width: "33%"}}> 
  ...
  Login
    ...
    <div className="SearchBar2"  style={{display: this.state.searchBar2 ? '': "none"}}>
      ...
      <div className='SmallSearchIcon'>
          <Icon type="search"  onClick={(e) => this.toggleSearch()}/>
      </div>
